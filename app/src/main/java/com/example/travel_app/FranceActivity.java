...
public class FranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHotels.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(FranceActivity.this, HotelsActivity.class);
            intent.putExtra("country", "France");  // Ülke adını gönderiyoruz
        ...
        btnFoods.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(FranceActivity.this, FoodActivity.class);
            intent.putExtra("country", "France");  // Ülke adını gönderiyoruz
            startActivity(intent);
        });
        ...
        btnPlaces.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(FranceActivity.this, PlacesActivity.class);
            intent.putExtra("country", "France");  // Ülke adını gönderiyoruz
            startActivity(intent);
        });
    }
