...
public class AustriaActivity extends AppCompatActivity {
    ...
    private final String countryName = "Austria";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCountryDescription.setText(
                "🇦🇹 \nAustria is a land of majestic mountains, classical music, and rich cultural heritage. " +
                        "From the imperial palaces of Vienna to the alpine beauty of Salzburg and the ski resorts of Tyrol, " +
                        "Austria offers breathtaking landscapes and world-class experiences year-round."
        );

        // Varsayılan: Hotels seçili
    ...
    private void shareCountryInfo() {
        String shareText = "Avusturya'daki favori yerlerimi keşfet! 🇦🇹\n" +
                "Oteller, yemekler ve gezilecek yerler burada:\n" +
                "mytravelapp://country/Austria";
