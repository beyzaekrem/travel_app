...
public class CroatiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHotels.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(CroatiaActivity.this, HotelsActivity.class);
            intent.putExtra("country", "Croatia");  // Ülke adını gönderiyoruz
        ...
        btnFoods.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(CroatiaActivity.this, FoodActivity.class);
            intent.putExtra("country", "Croatia");  // Ülke adını gönderiyoruz
            startActivity(intent);
        });
        ...
        btnPlaces.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(CroatiaActivity.this, PlacesActivity.class);
            intent.putExtra("country", "Croatia");  // Ülke adını gönderiyoruz
            startActivity(intent);
        });
    }
