...
public class ItalyActivity extends AppCompatActivity {
    ...
    private final String countryName = "Italy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCountryDescription.setText(
                "🇮🇹 \nItaly is a timeless destination where ancient ruins, renaissance art, romantic canals, " +
                        "and culinary delights converge. From Rome’s Colosseum to Venice’s winding waterways and Tuscany’s rolling vineyards, " +
                        "Italy offers a rich cultural experience for every traveler."
        );

        // Varsayılan durum: Hotels
    ...
    private void shareCountryInfo() {
        String shareText = "İtalya'daki favori yerlerimi keşfet! 🇮🇹\n" +
                "Oteller, yemekler ve gezilecek yerler burada:\n" +
                "mytravelapp://country/Italy";
